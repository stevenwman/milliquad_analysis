"""
Core MuJoCo simulation engine for the LEGO milliquad robot (16-param extended version).

Same physics as simulation_fast.py, but with 3 additional MuJoCo solver parameters:
- noslip_iterations: friction solver iteration count
- noslip_tolerance: friction convergence threshold
- margin: contact detection distance (o_margin attribute)
