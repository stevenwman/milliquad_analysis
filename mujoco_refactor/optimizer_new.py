"""
Batch optimization for multi-scene simulation parameter tuning (18-param extended version).

Supports two backends (set OPTIMIZER_BACKEND in config_new.py):
  - "skopt": Bayesian optimization via scikit-optimize (GP/RF surrogate)
  - "cmaes": CMA Evolution Strategy via pycma

Usage:
    cd mujoco_refactor
    uv run python optimizer_new.py
"""
...
# Extended 18-param version using simulation_fast_new.py
