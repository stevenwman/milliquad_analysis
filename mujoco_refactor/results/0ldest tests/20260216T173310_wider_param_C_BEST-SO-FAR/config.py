...
space: list[Real] = [
    ...
    Real(0.0001, 1.0, "log-uniform", name="solref_timeconst"),
    ...
    Real(0.1, 10.0, "log-uniform", name="magnetic_moment_fudge"),
    Real(0.1, 10.0, "log-uniform", name="magnetic_field_fudge"),
