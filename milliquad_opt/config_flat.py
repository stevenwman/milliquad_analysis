"""Flat terrain optimization config.

Defines REFERENCE_DATA (15 flat conditions), cost weights, cost function,
MJCF_PATHS, and CMAES_X0 for flat terrain optimization with RK4 integrator.
"""
...
# ---------------------------------------------------------------------------
# Reference data (15 flat conditions)
# ---------------------------------------------------------------------------
