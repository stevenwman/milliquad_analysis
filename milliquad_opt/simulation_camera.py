...
def run_simulation(
    ...
    Args:
        ...
        slow_mo: Slow-motion multiplier (2.0 = half speed, 0.5 = double speed).
    ...
    try:
        ...
        if visualize and not record_path:
            ...
            _capture_fps = capture_fps if capture_fps is not None else VIDEO_FRAMERATE
    ...
    if record_path:
        _cap_fps = capture_fps if capture_fps is not None else VIDEO_FRAMERATE
