"""Step terrain optimization config (65% spatial gate, batch=32).

Copy of config_step_065.py with BATCH_SIZE=32 and CMAES_SIGMA0=0.25.
Warm-start from 065 gate best for local refinement with larger population.
"""
